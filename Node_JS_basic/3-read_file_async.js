...
const fs = require('fs').promises; // pour la gestion des tâches asyncrones

const countStudents = async (filePath) => { // ajout de "async"
  try {
    /**
     * Lire le fichier de manière asynchrone :
     * Utilisation de "await" pour se substituer à "then" et "catch"
     */
